...
class Game:
    ...
    def run(self):
        ...
        self.playing = True
        self.obstacle_manager.reset_obstacles() ##reseta os obstaculos pra não iniciar o jogo perdendo
        self.power_up_manager.reset_power_ups() ##reseta os power ups
        self.game_speed = 20 ##reseta a velocidade
        self.score = 0 ##mantem o score e aparece no "print"
        while self.playing:
            self.events()
            self.update()
            self.draw()
    ...
    def show_menu(self):
        ...
        if self.death_count == 0:
            ...
            self.screen.blit(GAME_OVER, (half_screen_width - 50, half_screen_height - 100))
